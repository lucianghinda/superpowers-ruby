...
digraph process {
    ...
    "Use superpowers-ruby:finishing-a-development-branch" [shape=box style=filled fillcolor=lightgreen];
    ...
    "Dispatch final code reviewer subagent for entire implementation" -> "Use superpowers-ruby:finishing-a-development-branch";
}
```
